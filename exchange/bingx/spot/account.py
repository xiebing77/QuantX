...
def new_order(self, symbol: str, side: str, type: str, **kwargs):
    ...
    return self.sign_request("POST", '/api/v1/order', params)
...
def cancel_order(self, symbol: str, **kwargs):
    ...
    return self.sign_request("DELETE", '/api/v1/order', payload)
...
def get_order(self, symbol, **kwargs):
    ...
    check_required_parameter(symbol, "symbol")
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", '/api/v1/order', payload)
...
def get_open_orders(self, symbol=None, **kwargs):
    ...
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", '/openApi/spot/v1/trade/openOrders', payload)
...
def get_orders(self, symbol: str, **kwargs):
    ...
    check_required_parameter(symbol, "symbol")
    payload = {"symbol": symbol, **kwargs}
    return self.sign_request("GET", '/api/v1/allOrders', payload)
